<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="招聘名称" prop="zhaopinmingcheng">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="upload" v-if="type!='info' && !ro.zhaopintupian" label="招聘图片" prop="zhaopintupian">
					<file-upload
						...
						:limit="3"
						:multiple="true"
						:fileUrls="ruleForm.zhaopintupian?ruleForm.zhaopintupian:''"
						@change="zhaopintupianUploadChange"
					></file-upload>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="upload" v-else-if="ruleForm.zhaopintupian" label="招聘图片" prop="zhaopintupian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="薪酬待遇" prop="xinchoudaiyu">
					<el-input v-model="ruleForm.xinchoudaiyu" placeholder="薪酬待遇" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="招聘要求" prop="zhaopinyaoqiu">
					<el-input v-model="ruleForm.zhaopinyaoqiu" placeholder="招聘要求" clearable  :readonly="ro.zhaopinyaoqiu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="招聘要求" prop="zhaopinyaoqiu">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="联系手机" prop="lianxishouji">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="textarea" v-if="type!='info'" label="招聘简介" prop="zhaopinjianjie">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="招聘简介"
					  v-model="ruleForm.zhaopinjianjie" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else-if="ruleForm.zhaopinjianjie" label="招聘简介" prop="zhaopinjianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.zhaopinjianjie}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-if="type!='info'"  label="招聘内容" prop="zhaopinneirong">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else-if="ruleForm.zhaopinneirong" label="招聘内容" prop="zhaopinneirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.zhaopinneirong"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zhaopintupian'){
							this.ruleForm.zhaopintupian = obj[o];
							this.ro.zhaopintupian = true;
							continue;
						}
						...
						if(o=='zhaopinjianjie'){
							this.ruleForm.zhaopinjianjie = obj[o];
							this.ro.zhaopinjianjie = true;
							continue;
						}
						if(o=='zhaopinneirong'){
            ...
            this.$http({
				...
				if (data && data.code === 0) {
					this.zhiweimingchengOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.zhaopinneirong = this.ruleForm.zhaopinneirong.replace(reg,'../../../springboot123456/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.zhaopintupian!=null) {
		this.ruleForm.zhaopintupian = this.ruleForm.zhaopintupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    zhaopintupianUploadChange(fileUrls) {
	    this.ruleForm.zhaopintupian = fileUrls;
    },
  }
};
</script>
