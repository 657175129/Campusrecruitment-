	...
	<div class="addEdit-block" :style='{"padding":"30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="投递备注" prop="toudibeizhu">
					<el-input v-model="ruleForm.toudibeizhu" placeholder="投递备注" clearable  :readonly="ro.toudibeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="投递备注" prop="toudibeizhu">
					<el-input v-model="ruleForm.toudibeizhu" placeholder="投递备注" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="date" v-if="type!='info'" label="投递日期" prop="toudiriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-else-if="ruleForm.toudiriqi" label="投递日期" prop="toudiriqi">
