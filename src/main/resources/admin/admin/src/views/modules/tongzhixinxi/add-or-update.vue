<template>
	<div class="addEdit-block" :style='{"padding":"30px 0 0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' class="input" v-if="type!='info'"  label="通知名称" prop="tongzhimingcheng">
					<el-input v-model="ruleForm.tongzhimingcheng" placeholder="通知名称" clearable  :readonly="ro.tongzhimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","display":"inline-block"}' v-else class="input" label="通知名称" prop="tongzhimingcheng">
